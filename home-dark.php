...
<body class="bg-fixed dark-layout" style="background-image: url(assets/img/shape/banner-2.jpg);">
    ...
    <div id="portfolio" class="portfolio-style-six-area default-padding-top">
        <div class="shape-animated-right">
            <img src="assets/img/shape/1-light.png" alt="Shape">
        </div>
                    ...
                    <div class="col-lg-6 offset-lg-1">
                        ...
                        <div class="pricing-style-one">
                            <div class="conntent">
                                ...
                                <a class="btn mt-25 btn-sm circle btn-light" href="#contact">Order Now</a>
                            </div>
                            <div class="price">
                                <h2><sup>$</sup>24</h2>
                                <i class="fab fa-html5"></i>
                        ...
                        <div class="brand5col swiper">
                            ...
                            <div class="swiper-wrapper align-center">
                                ...
                                <div class="swiper-slide">
                                    <img src="assets/img/logo/1-light.png" alt="Thumb">
                                </div>
                                <!-- End Single Item -->
                                <!-- Single Item -->
                                <div class="swiper-slide">
                                    <img src="assets/img/logo/2-light.png" alt="Thumb">
                                </div>
                                <!-- End Single Item -->
                                <!-- Single Item -->
                                <div class="swiper-slide">
                                    <img src="assets/img/logo/4-light.png" alt="Thumb">
                                </div>
                                <!-- End Single Item -->
                                <!-- Single Item -->
                                <div class="swiper-slide">
                                    <img src="assets/img/logo/5-light.png" alt="Thumb">
                                </div>
                                <!-- End Single Item -->
                                <!-- Single Item -->
                                <div class="swiper-slide">
                                    <img src="assets/img/logo/3-light.png" alt="Thumb">
                                </div>
                                <!-- End Single Item -->
                            </div>
                        </div>
    ...
    <div class="work-available-area text-center box-layout bg-light default-padding">
        <div class="shape-right-top-mini">
            <img src="assets/img/shape/16-light.png" alt="illustration">
        </div>
                ...
                <div class="row align-center">
                    ...
                    <div class="col-lg-7 contact-form-box mb-md-50 mb-xs-50">
                        <div class="form-box">
                            ...
                            <form action="https://validthemes.live/themeforest/ambrox/assets/mail/contact.php" method="POST" class="contact-form">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
