...
//        $q2 = mysql_query($sql2) or die(mysql_error() . $sql2);
        ...
        echo "<script>alert('New Subscribe Created');window.location='index.php?p=newsletter';</script>";
    }
}
?>
                                        ...
                                        <div class="widget box" style="border:none;">
                                            <div class="widget-content">
                                                ...
                                                <div class="form-group has-error" >
                                                    ...
                                                    <div class="col-md-9"> <input type="text" name="email" class="form-control required has-error" style="border-radius: 6px;">
