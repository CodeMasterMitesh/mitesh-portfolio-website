...
if (isset($_POST['update'])) {
        ...
        if ($a != 'update' && !in_array($a, $escape)) {
            ...
            if (is_array($b)) {
               ...
               for ($i = 0; $i < count($b); $i++) {
                  ...
                  if (strpos($a, "time") || strpos($a, "date") || $a == 'reviewdate')
                        $pb1[] = dmy2mysql($b[$i]);
                   else
                        $pb1[] = $b[$i];
               }                $dd.="'" . implode(",", $pb1) . "'";
    ...
    if ($q) {
        echo "<script>alert('Feedback Updated');window.location='index.php?p=feedback'; </script>"; //
    }
}
$sql = "select * from feedback1 where id=" . $_GET['id'];
$q = mysql_query($sql);
...
if ($_GET['del']) {   // when click on delete link this will be called and delete image from database
    ...
    $q = mysql_query($sql);
    echo "<script>alert('Feedback Updated'); window.location='index.php?p=editfeedback&id=" . $_GET['id'] . "';</script>";
}
?> 
                        ...
                        <div class="panel-group" id="accordion">
                            <div class="panel panel-default" style="margin-left: -5px;">
                                <div class="panel-heading">
                                    <h3 class="panel-title"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseOne"> Edit Comment </a> </h3>
                                </div>
...
<!--                                                    <td> 
                                                        ...
                                                        <input class="select1" type="text" name="reviewdate" class="medium" class="form-control datepicker" autocomplete="off"> 
                                                    </td>-->
                                                    <td>

                                                        <label style="width:125px;">Name:</label>   
                                                        <input class="select1"  type="text" name="name" class="medium" autocomplete="off">
                                                    </td>
                                                    <td>  
                                                    ...
                                                    <td>  
                                                       ...
                                                       <input class="select1"  type="text" name="phone" class="medium" autocomplete="off">
                                               
                                                    </td><td>  
                                                        <label style="width:125px;"> Message:</label>
                                                       <input class="select1"  type="text" name="message" class="medium" autocomplete="off">
...
<!--                                                <tr>
                                                    <td colspan="2">
                                                        <label style="width:125px;">Review</label>
...
<!--                                                <tr>
                                                    <td colspan="2">
                                                        ...
                                                        <textarea name="review" cols="10" style="width:100%"><?php echo $rdata['review'];?></textarea>
...
foreach ($rdata as $a => $b) {
    ...
    if (strpos($a, "date") || $a == "date" || strpos($a, "reviewdate") || $a == 'datetime')
