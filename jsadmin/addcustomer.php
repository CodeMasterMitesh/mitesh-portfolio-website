...
if (isset($_POST['submit'])) {
    ...
    if ($q)
        echo "<script>alert('New customers Created');window.location='index.php?p=customer';</script>";
   
}
?>
<div class="page-header" style="margin: 20px;">
    <div class="page-title">
        <h3>New Profile(Customers)</h3>
    </div>
</div>
                                            ...
                                            <div class="widget-content">
                                                <div class="form-group has-error" >
                                                    <div class="control-group">
                                                        <label for="email" class=" col-md-2 control-label cm-required cm-email">Name:<span class="required">*</span></label> 
                                                        <div class="col-md-9">
                                                ...
                                                <div class="form-group has-error" >
                                                    <div class="control-group">
                                                        <label for="email" class=" col-md-2 control-label cm-required cm-email">Email:<span class="required">*</span></label> 
                                                        <div class="col-md-9">
                                            ...
                                            <div class="widget-content">
                                                <div class="form-group has-error" style="border-top:none;">
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <div class="col-md-9"> 
                                                            <input type="text" name="mobile" class="form-control required has-error" style="border-radius: 6px;"><label for="req1" generated="true" class="has-error help-block" style="color:#fff;">.</label> 
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group has-error" style="border-top:none;">
...
<!--                                                <div class="form-group has-error" style="border-top:none;">
                                                ...
                                                <div class="form-group has-error" style="border-top:none;">
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <div class="col-md-9"> 
                                                            <input type="text" name="billing_city" class="form-control required has-error" style="border-radius: 6px;"><label for="req1" generated="true" class="has-error help-block" style="color:#fff;">.</label> 
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group has-error" style="border-top:none;">
                                                ...
                                                <div class="form-group has-error" style="border-top:none;">
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <div class="col-md-9"> 
                                                            <input type="text" name="billing_zipcode" class="form-control required has-error" style="border-radius: 6px;"><label for="req1" generated="true" class="has-error help-block" style="color:#fff;">.</label> 
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="widget-content">
                                                <div class="form-group has-error" style="border-top:none;">
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <div class="col-md-9"> 
                                                            <input type="text" name="phone" class="form-control required has-error" style="border-radius: 6px;"><label for="req1" generated="true" class="has-error help-block" style="color:#fff;">.</label> 
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group has-error" style="border-top:none;">
                                                    ...
                                                    <div class="control-group">
                                                        <label class="col-md-2 control-label" for="elm_category_page_title">Address<a class="cm-tooltip"></a>:</label>
                                                        <div class="col-md-9"> 
                                                            <input type="text" name="shipping_address" class="form-control required has-error" style="border-radius: 6px;"><label for="req1" generated="true" class="has-error help-block" style="color:#fff;">.</label> 
                                                        </div>
                                                    </div>
                                                </div>
<!--                                                <div class="form-group has-error" style="border-top:none;">
                                                ...
                                                <div class="form-group has-error" style="border-top:none;">
                                                    ...
                                                    <div class="control-group">
                                                        <label class="col-md-2 control-label" for="elm_category_page_title">City<a class="cm-tooltip"></a>:</label>
                                                        <div class="col-md-9"> 
                                                            <input type="text" name="shipping_city" class="form-control required has-error" style="border-radius: 6px;"><label for="req1" generated="true" class="has-error help-block" style="color:#fff;">.</label> 
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group has-error" style="border-top:none;">
                                                ...
                                                <div class="form-group has-error" style="border-top:none;">
                                                    ...
                                                    <div class="control-group">
                                                        <label class="col-md-2 control-label" for="elm_category_page_title">Zip/postal code<a class="cm-tooltip"></a>:</label>
                                                        <div class="col-md-9"> 
                                                            <input type="text" name="shipping_zipcode" class="form-control required has-error" style="border-radius: 6px;"><label for="req1" generated="true" class="has-error help-block" style="color:#fff;">.</label> 
                                                        </div>
                                                    </div>
                                                </div>
