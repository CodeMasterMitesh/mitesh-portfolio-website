...
if (isset($_POST['update'])) {
    ...
    if ($q) {
        echo "<script>alert('Users Updated'); </script>"; //window.location='index.php?p=searchproduct';
    }
}
...
if ($_GET['del']) {   // when click on delete link this will be called and delete image from database
    ...
    $q = mysql_query($sql);
    echo "<script>alert('Users Updated'); window.location='index.php?p=edituser&id=" . $_GET['id'] . "';</script>";
}
?> 

<div class="page-header" style="margin: 20px;">
    <div class="page-title">
        <h3>Editing Profile(users)</h3>
    </div>
</div>
