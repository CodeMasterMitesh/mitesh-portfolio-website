...
if (isset($_POST['update'])) {
    ...
    if ($q) {
        echo "<script>alert('Review Updated');window.location='index.php?p=comments'; </script>"; //
    }
}
$sql = "select * from productreview where id=" . $_GET['id'];
$q = mysql_query($sql);
...
if ($_GET['del']) {   // when click on delete link this will be called and delete image from database
    ...
    $q = mysql_query($sql);
    echo "<script>alert('Review Updated'); window.location='index.php?p=editproductreview&id=" . $_GET['id'] . "';</script>";
}
?>
                            ...
                            <div class="panel panel-default" style="margin-left: -5px;">
                                <div class="panel-heading">
                                    <h3 class="panel-title"> <a class="accordion-toggle" data-toggle="collapse"
                                            data-parent="#accordion" href="#collapseOne"> Edit Comment </a> </h3>
                                </div>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input class="select1" type="text" name="date" class="medium"
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <select name="allow" class="select1 ">
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        ...
                                                        <textarea
                                                            name="review"><?php echo $rdata['review']; ?></textarea>
