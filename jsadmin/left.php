...
<!--         <div id="sidebar" class="sidebar-fixed">
            <div id="sidebar-content">
               <form class="sidebar-search">
                  <div class="input-box"> <button type="submit" class="submit"> <i class="icon-search"></i> </button> <span> <input type="text" placeholder="Search..."> </span> </div>
               </form>
               ...
               <ul id="nav">
                  <li class="current"> <a href="index.php?p=dashboard.php"> <i class="icon-dashboard"></i> Dashboard </a> </li>
                  <li>
                     <a href="javascript:void(0);"> <i class="icon-desktop"></i>  Orders<span class="label label-info pull-right">6</span> </a> 
                     <ul class="sub-menu">
                        <li> <a href="ui_general.html"> <i class="icon-angle-right"></i> View orders </a> </li>
                        <li> <a href="ui_buttons.html"> <i class="icon-angle-right"></i> Sales reports </a> </li>
                        <li> <a href="ui_tabs_accordions.html"> <i class="icon-angle-right"></i> Shipments </a> </li>
                        <li> <a href="ui_sliders.html"> <i class="icon-angle-right"></i> Recurring plans </a> </li>
                        <li> <a href="ui_nestable_list.html"> <i class="icon-angle-right"></i>View subscriptions </a> </li>
                        <li> <a href="ui_typography.html"> <i class="icon-angle-right"></i> Subscription events </a> </li>
                  ...
                  <li>
                     ...
                     <ul class="sub-menu">
                        <li> <a href="form_components.html"> <i class="icon-angle-right"></i> Users </a> </li>
                        <li> <a href="form_layouts.html"> <i class="icon-angle-right"></i> Administrators </a> </li>
                        <li> <a href="form_validation.html"> <i class="icon-angle-right"></i> Customers </a> </li>
                        <li> <a href="form_components.html"> <i class="icon-angle-right"></i> Affiliates </a> </li>
                        <li> <a href="form_layouts.html"> <i class="icon-angle-right"></i> User groups </a> </li>
                        <li> <a href="form_validation.html"> <i class="icon-angle-right"></i> Events </a> </li>
                     </ul>
                  </li>
                                          <li>
                     ...
                     <ul class="sub-menu">
                        <li class="open-default">
                           <a <?php
                                    ...
                                    ?>href="index.php?p=addproduct"> <i class="icon-cogs"></i> Products <span class="arrow"></span> </a> 
                                                               <ul class="sub-menu">
                              <li class="open-default">
                                  <a href="javascript:void(0);"> <i class="icon-user"></i> Browse Products <span class="arrow"></span> </a> 
                                  <ul class="sub-menu">
                                      <li class="current"><a href="javascript:void(0);"><i class="icon-remove"></i> Sample Link 1</a></li>
                                      <li><a href="javascript:void(0);"><i class="icon-pencil"></i> Sample Link 1</a></li>
                                      <li><a href="javascript:void(0);"><i class="icon-edit"></i> Sample Link 1</a></li>
                              ...
                              <li><a href="javascript:void(0);"><i class="icon-external-link"></i>Add New Products</a></li>
                              <li><a href="javascript:void(0);"><i class="icon-external-link"></i> Sample Link 2</a></li>
                              <li><a href="javascript:void(0);"><i class="icon-bell"></i> Sample Link 3</a></li>
                              </ul>
                        </li>
                        <li>
                           <a href="javascript:void(0);"> <i class="icon-globe"></i> Categories <span class="arrow"></span> </a> 
                                                               <ul class="sub-menu">
                              <li><a href="javascript:void(0);"><i class="icon-user"></i> Browse Categories</a></li>
                              <li><a href="javascript:void(0);"><i class="icon-external-link"></i>Add New Categories </a></li>
                              <li><a href="javascript:void(0);"><i class="icon-bell"></i> Sample Link 1</a></li>
                              </ul>
                        </li>
                        <li> <a href="javascript:void(0);"> <i class="icon-folder-open"></i> Filters </a> </li>
                        <li> <a href="javascript:void(0);"> <i class="icon-bell"></i> Options </a> </li>
                        <li>
                           <a href="javascript:void(0);"> <i class="icon-user"></i> Features </a> 
                                                            <ul class="sub-menu">
                              <li><a href="javascript:void(0);"><i class="icon-user"></i> Manufacturers</a></li>
                              <li><a href="javascript:void(0);"><i class="icon-external-link"></i>Product Groups</a></li>
                               <li><a href="javascript:void(0);"><i class="icon-user"></i> Product Reviews</a></li>
                              <li><a href="javascript:void(0);"><i class="icon-external-link"></i>Global Attributes</a></li>
                               <li><a href="javascript:void(0);"><i class="icon-user"></i> Add a New Global Attributes</a></li>
                              <li><a href="javascript:void(0);"><i class="icon-bell"></i> Recommended Products</a></li>
                              <li><a href="javascript:void(0);"><i class="icon-bell"></i> Add Recommended Product Family</a></li>
                              </ul>
                        </li>
                     </ul>
                  </li>
