...
if (isset($_POST['update'])) {
    ...
    if ($q) {
        echo "<script>alert('Administrator Updated'); </script>"; //window.location='index.php?p=searchproduct';
    }
}
...
if ($_GET['del']) {   // when click on delete link this will be called and delete image from database
    ...
    $sql = "update administrator set `" . $_GET['del'] . "`='" . implode(',', $datadel) . "' where id=" . $_GET['id'];
    $q = mysql_query($sql);
    echo "<script>alert('Administrator Updated'); window.location='index.php?p=editadministrator&id=" . $_GET['id'] . "';</script>";
}
?>

<div class="page-header" style="margin: 20px;">
    <div class="page-title">
        <h3>Editing Profile(Administrator)</h3>
    </div>
</div>
                    ...
                    <div class="widget-content">
                        <div class="panel-group" id="accordion">
                            <div class="panel panel-default" style="margin-left: -5px;">
                                <div class="panel-heading">
                                    <h3 class="panel-title"> <a class="accordion-toggle" data-toggle="collapse"
                                            data-parent="#accordion" href="#collapseOne"> User account information </a>
                                    </h3>
                                </div>
                                            ...
                                            <div class="widget-content">
                                                <div class="form-group has-error">
                                                    <div class="control-group">
                                                        <label for="email"
                                                            class=" col-md-2 control-label cm-required cm-email">Email:<span
                                                ...
                                                <div class="form-group has-error" style="border-top:none;">
                                                    ...
                                                    <div class="form-group" style="border-top:none;">
                                                        <div class="control-group">
                                                            <label class="col-md-2 control-label" for="tax_exempt">Tax
                                                                exempt:</label>
                                                            <!--                                                            <input type="hidden" name="user_data[tax_exempt]" value="N">-->
                                                            <div class="controls">
                                                                <input id="tax_exempt" type="checkbox" name="user_data"
                                                                    value="Y">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group" style="border-top:none;">
                                                        <div class="control-group">
                                                            <label class=" col-md-2 control-label"
                                                                for="user_language">Language</label>
                                                            <div class="controls">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"> <a class="accordion-toggle" data-toggle="collapse"
                                            data-parent="#accordion" href="#collapseOne"> Billing address </a> </h3>
                                </div>
                                <div id="collapseOne" class="panel-collapse in" style="height: auto;">
                                    <div class="panel-body">
                                        <div class="widget box" style="border:none;">
                                            <div class="widget-content">
                                                <div class="form-group has-error">
                                                    <div class="control-group">
                                                        <label class="col-md-2 control-label"
                                                            for="elm_category_page_title">First Name<a
                                                                class="cm-tooltip"></a>:</label>
                                                        <div class="col-md-9">
                                                ...
                                                <div class="form-group has-error" style="border-top:none;">
                                                    ...
                                                    <div class="control-group">
                                                        <label class="col-md-2 control-label"
                                                            for="elm_category_page_title">Last Name<a
                                                                class="cm-tooltip"></a>:</label>
                                                        <div class="col-md-9">
                                                ...
                                                <div class="form-group has-error" style="border-top:none;">
                                                    ...
                                                    <div class="control-group">
                                                        <label class="col-md-2 control-label"
                                                            for="elm_category_page_title">Phone<a
                                                                class="cm-tooltip"></a>:</label>
                                                        <div class="col-md-9">
                                                ...
                                                <div class="form-group has-error" style="border-top:none;">
                                                    ...
                                                    <div class="control-group">
                                                        <label class="col-md-2 control-label"
                                                            for="elm_category_page_title">Address<a
                                                                class="cm-tooltip"></a>:</label>
                                                        <div class="col-md-9">
                                                ...
                                                <div class="form-group has-error" style="border-top:none;">
                                                    ...
                                                    <div class="control-group">
                                                        <label class="col-md-2 control-label"
                                                            for="elm_category_page_title">City<a
                                                                class="cm-tooltip"></a>:</label>
                                                        <div class="col-md-9">
                                                ...
                                                <div class="form-group has-error" style="border-top:none;">
                                                    <div class="control-group">
                                                        <label for="elm_26"
                                                            class="col-md-2 control-label cm-profile-field  ">Country:</label>

                                                        <div class="col-md-9">


                                                            <select class="select1" id="elm_26"
                                                ...
                                                <div class="form-group has-error" style="border-top:none;">
                                                    <div class="control-group">
                                                        <label for="elm_24"
                                                            class="col-md-2 control-label cm-profile-field  ">State/province:</label>

                                                        <div class="col-md-9">
                                                            <select class="select1" class="cm-state cm-location-billing"
                                                                id="elm_24" name="billstate">
                                                ...
                                                <div class="form-group has-error" style="border-top:none;">
                                                    ...
                                                    <div class="control-group">
                                                        <label class="col-md-2 control-label"
                                                            for="elm_category_page_title">Zip/postal code<a
                                                                class="cm-tooltip"></a>:</label>
                                                        <div class="col-md-9">
                                                            <input type="text" name="billpincode"
                                                                class="form-control required has-error"
                                                                style="border-radius: 6px;"><label for="req1"
                                                                generated="true" class="has-error help-block"
                                                                style="color:#fff;">.</label>
                                                ...
                                                <div class="form-group has-error" style="border-top:none;">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            ...
                                                            <input type="text" id="elm_24_d" name="user_data[b_state]"
                                                                size="32" maxlength="64" value="MA" disabled=""
                                                                class="cm-state cm-location-billing input-large hidden cm-skip-avail-switch">
                                                    ...
                                                    <div class="control-group">
                                                        <label class="col-md-2 control-label"
                                                            for="elm_category_page_title">Zip/postal code<a
                                                                class="cm-tooltip"></a>:</label>
                                                        <div class="col-md-9">
                                                            <input type="text" name="shippincode"
                                                                class="form-control required has-error"
                                                                style="border-radius: 6px;"><label for="req1"
                                                                generated="true" class="has-error help-block"
                                                                style="color:#fff;">.</label>
