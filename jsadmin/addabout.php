...
if (isset($_POST['submit'])) {
    ...
    if ($q)
        echo "<script>alert('New about Created');window.location='index.php?p=about';</script>";
}
?>
                            ...
                            <div class="panel panel-default" style="margin-left: -5px;">
                                <div class="panel-heading">
                                    <h3 class="panel-title"> <a class="accordion-toggle" data-toggle="collapse"
                                            data-parent="#accordion" href="#collapseOne"> Inception </a> </h3>
                                </div>
                                        ...
                                        <div class="widget box" style="border:none;">
                                            <div class="widget-content">
                                                <div class="form-group has-error">
                                                    <label class="col-md-2 control-label">Heading <span
                                                ...
                                                <!-- <div class="form-group has-error" style="border:none;">
                                                    <label class="col-md-2 control-label">Rating<span class="required">*</span></label> 
                                                    <div class="col-md-2" id="subcategory"> 
                                                ...
                                                <div class="form-group has-error">
                                                    <label class="col-md-2 control-label">Text<span
                                                            class="required">*</span></label>
                                                    <div class="col-md-6">
