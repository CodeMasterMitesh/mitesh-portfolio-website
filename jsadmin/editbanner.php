...
if (isset($_POST['update'])) {
    ...
    if ($q) {
        echo "<script>alert('Banner Updated');window.location='index.php?p=banner' </script>";
    }
}
...
if (isset($_GET['del'])) {   // when click on delete link this will be called and delete image from database
    ...
    $sql = "update banner set `" . $_GET['del'] . "`='" . implode(',', $datadel) . "' where id=" . $_GET['id'];
    $q = mysql_query($sql);
    echo "<script>alert('Banner Updated'); window.location='index.php?p=banner&id=" . $_GET['id'] . "';</script>";
}
?>
...
<div class="tabbable tabbable-custom" style="margin: 20px;">
    ...
    <form class="form-horizontal row-border" id="validate-1" method="post" enctype="multipart/form-data" action=""
        ...
        <!--        <input type="hidden" value="banner" name="db"/>
                                            ...
                                            <div class="widget-content">
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <select class="select1" id="elm_category_default_layout" class="cm-combo-select cm-toggle-element" name="type">
                                                                <?php
                                                                if ($rdata['type'] == 'Graphic banner') {
                                                                ?>
                                                                    <option selected="">Graphic banner</option>
                                                                    <option>Text banner</option>
                                                                    <?php
                                                                }
                                                                if ($rdata['type'] == 'Text banner') {
                                                                    ?>
                                                                    <option>Graphic banner</option>
                                                                    <option selected="">Text banner</option>
                                                                <?php } ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group has-error" style="border-top:none;">
                                                    <div class="form-group" style="border-top:none;">
                                                        <label class="col-md-2 control-label" for="image">Image
                                                            1:</label>
                                                        <div class="col-md-9">
                                                            <?php
                                                            if (
                                                    ...
                                                    <!-- mobile image  -->
                                                    <div class="form-group" style="border-top:none;">
                                                        <label class="col-md-2 control-label" for="image">Mobile Image
                                                        </label>
                                                        <div class="col-md-9">
                                                            <?php
                                                            if (
                                                                substr($rdata['mobileimage'], -3) == 'png' || substr($rdata['mobileimage'], -3) == 'jpg' || substr($rdata['mobileimage'], -3) == 'JPG' || substr($rdata['mobileimage'], -4) == 'jpeg' || substr($rdata['mobileimage'], -3) == 'gif' || substr($rdata['mobileimage'], -3) == 'bmp'
                                                                || substr($rdata['mobileimage'], -3) == 'svg'
                                                                || substr($rdata['mobileimage'], -3) == 'SVG'
                                                            ) {
                                                                echo '<input name="mobileimage" value="' . $rdata['mobileimage'] . '" type="hidden" class="form-control   edit_product_image product_image  " > <img src="../files/' . $rdata['mobileimage'] . '" style="width:200px;" /> <br/> <a onclick="$(this).parent().find(\'input\').attr(\'type\',\'file\');$(this).parent().find(\'img,a\').remove()">Delete</a>';
                                                            } elseif ($rdata['mobileimage']) {
                                                                echo '<input name="mobileimage" value="' . $rdata['mobileimage'] . '" type="hidden" class="form-control edit_product_image product_image  " > <a target="_BLANK" href="../files/' . $rdata['mobileimage'] . '" style="width:200px;" >Download ' . $rdata['mobileimage'] . '</a> <br/> <a onclick="$(this).parent().find(\'input\').attr(\'type\',\'file\');$(this).parent().find(\'img,a\').remove()">Delete</a>';
                                                            } else {
                                                            ?>
                                                            <input type="file" name="mobileimage"
                                                                class="form-control required has-error"
                                                                style="border-radius: 6px;width:350px;">
                                                            <?php } ?>
                                                            <label for="req2" generated="true"
                                                                class="has-error help-block"
                                                                style="color:#fff;">.</label>
                                                        </div>
                                                        <div class="controls"></div>
                                                    ...
                                                    <div class="form-group has-error" style="border-top:none;">
                                                        ...
                                                        <div class="col-md-10">
                                                            <textarea
                                                                name="heading"><?php echo $rdata['heading']; ?></textarea>
                                                    ...
                                                    <div class="form-group has-error" style="border-top:none;">
                                                        ...
                                                        <div class="col-md-10">
                                                            <textarea
                                                                name="subdec"><?php echo $rdata['subdec']; ?></textarea>
                                                            <script src="tinymce/tinymce.min.js"></script>
                                                            <script>
                                                            tinymce.init({
                                                                selector: 'textarea',
