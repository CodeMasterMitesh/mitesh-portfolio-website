...
if (isset($_POST['submit'])) {
    ...
    if ($q)
        echo "<script>alert('New certificate Created'); window.location='index.php?p=certificate';</script>";
}
?>
                                            ...
                                            <div class="widget-content">
                                                ...
                                                <div class="form-group has-error" style="border-top:none;">
                                                    ...
                                                    <!--                                                    <div class="form-group has-error" style="border:none;">
                                                        ...
                                                        <div class="col-md-9"> <input type="text" name="url" class="form-control required has-error" style="border-radius: 6px;"><label for="req1" generated="true" class="has-error help-block" style="color:#fff;">.</label>  </div>
                                                    </div>-->
                                                    <!-- <div class="form-group" style="border-top:none;">
                                                       <div class="form-group" style="border-top:none;">
