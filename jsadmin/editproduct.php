...
if (isset($_POST['update'])) {
    ...
    if ($q) {
        ...
        // }
        // $j = $i;
        echo "<script>alert('Product Updated');window.location='index.php?p=product';</script>";
        //
        //window.location='index.php?p=searchproduct';
    }
}
...
<div class="page-header" style="margin: 20px;">
    <div class="page-title">
        <h3>Edit Products <a href="#" class="btn btn-primary btn-primary " target="_BLANK">Html Page</a></h3>
    </div>
</div>
...
//                                                            debug($r2);
                                                ...
                                                <div class="form-group has-error" style="border:none;">
                                                    <div class="form-group has-error" style="border-top:none;">
                                                        ...
                                                        <div class="col-md-10">
                                                            <textarea
                                                                name="sdescription"><?php echo $rdata['sdescription']; ?></textarea>
                                                    ...
                                                    <div class="form-group has-error" style="border-top:none;">
                                                        ...
                                                        <div class="col-md-10">
                                                            <textarea
                                                                name="adress"><?php echo $rdata['adress']; ?></textarea>
                                                            <script src="tinymce/tinymce.min.js"></script>
                                                            <script>
                                                            tinymce.init({
                                                                selector: 'textarea',
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"> <a class="accordion-toggle" data-toggle="collapse"
                                            data-parent="#accordion" href="#collapseOne"> Key Features </a> </h3>
                                </div>
                                <div id="collapseOne" class="panel-collapse in" style="height: auto;">
                                    <div class="panel-body">
                                        <div class="widget box" style="border:none;">
                                                ...
                                                <div id="acc_pricing_inventory" class="collapse in">
                                                    <div class="form-group has-error" style="border:none;">
                                                        <div class="control-group">
                                                            <label class="col-md-2 control-label" for="top_speed">Top
                                                                Speed:</label>
                                                            <div class="col-md-9"> <input type="text" name="top_speed"
                                                                    class="form-control required has-error"
                                                                    style="border-radius: 6px;width:350px;"><label
                            ...
                            <!-- <div class="form-group has-error" style="border:none;">
                                                        <div class="control-group">
                                                            <label class="col-md-2 control-label" for="elm_min_qty">
                                                                Charging Time(Hour):</label>
                            ...
                            <!-- <div class="form-group has-error" style="border:none;">
                                                        <div class="control-group">
                                                            <label class="col-md-2 control-label"
                                                                for="wchargingtime">Charging Time(W):</label>
                                                            <div class="col-md-9"> <input type="text"
                                                                    name="wchargingtime"
                                                                    class="form-control required has-error"
                                                ...
                                                <div class="form-group has-error" style="border:none;">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <?php
                                                            if (
                                                                substr($rdata['thumbnail'], -3) == 'png' || substr($rdata['thumbnail'], -3) == 'jpg' || substr($rdata['thumbnail'], -4) == 'jpeg' || substr($rdata['thumbnail'], -3) == 'gif' || substr($rdata['thumbnail'], -3) == 'bmp'
                                                                || substr($rdata['thumbnail'], -3) == 'PNG' || substr($rdata['thumbnail'], -3) == 'JPG' || substr($rdata['thumbnail'], -4) == 'JPEG' || substr($rdata['thumbnail'], -3) == 'GIF' || substr($rdata['thumbnail'], -3) == 'BMP'
                                                            ) {
                                                ...
                                                <div class="form-group has-error" style="border:none;">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <?php
                                                            if (
                                                                substr($rdata['image1'], -3) == 'png' || substr($rdata['image1'], -3) == 'jpg' || substr($rdata['image1'], -4) == 'jpeg' || substr($rdata['image1'], -3) == 'gif' || substr($rdata['image1'], -3) == 'bmp'
                                                                || substr($rdata['image1'], -3) == 'svg'
                                                                || substr($rdata['image1'], -3) == 'SVG'
                                                                ||
                                                                substr($rdata['image1'], -3) == 'PNG' || substr($rdata['image1'], -3) == 'JPG' || substr($rdata['image1'], -4) == 'JPEG' || substr($rdata['image1'], -3) == 'GIF' || substr($rdata['image1'], -3) == 'BMP'
                                                            ) {
                                                ...
                                                <div class="form-group has-error" style="border:none;">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <?php
                                                            if (
                                                                substr($rdata['image2'], -3) == 'png' || substr($rdata['image2'], -3) == 'jpg' || substr($rdata['image2'], -4) == 'jpeg' || substr($rdata['image2'], -3) == 'gif' || substr($rdata['image2'], -3) == 'bmp'
                                                                ||
                                                                substr($rdata['image2'], -3) == 'PNG' || substr($rdata['image2'], -3) == 'JPG' || substr($rdata['image2'], -4) == 'JPEG' || substr($rdata['image2'], -3) == 'GIF' || substr($rdata['image2'], -3) == 'BMP'
                                                            ) {
                                                                echo '<input name="image2" value="' . $rdata['image2'] . '" type="hidden" class="form-control   edit_product_image2 product_image2  " > <img src="../files/' . $rdata['image2'] . '" style="width:200px;" /> <br/> <a onclick="$(this).parent().find(\'input\').attr(\'type\',\'file\');$(this).parent().find(\'img,a\').remove()">Delete</a>';
                                                            } elseif ($rdata['image2']) {
                                                                echo '<input name="image2" value="' . $rdata['image2'] . '" type="hidden" class="form-control edit_product_image2 product_image2  " > <a target="_BLANK" href="../files/' . $rdata['image2'] . '" style="width:200px;" >Download ' . $rdata['image2'] . '</a> <br/> <a onclick="$(this).parent().find(\'input\').attr(\'type\',\'file\');$(this).parent().find(\'img,a\').remove()">Delete</a>';
                                                            } else {
                                                            ?>
                                                ...
                                                <div class="form-group has-error" style="border:none;">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <?php
                                                            if (
                                                                substr($rdata['image3'], -3) == 'png' || substr($rdata['image3'], -3) == 'jpg' || substr($rdata['image3'], -4) == 'jpeg' || substr($rdata['image3'], -3) == 'gif' || substr($rdata['image3'], -3) == 'bmp'
                                                                ||
                                                                substr($rdata['image3'], -3) == 'PNG' || substr($rdata['image3'], -3) == 'JPG' || substr($rdata['image3'], -4) == 'JPEG' || substr($rdata['image3'], -3) == 'GIF' || substr($rdata['image3'], -3) == 'BMP'
                                                            ) {
                                                                echo '<input name="image3" value="' . $rdata['image3'] . '" type="hidden" class="form-control   edit_product_image3 product_image3  " > <img src="../files/' . $rdata['image3'] . '" style="width:200px;" /> <br/> <a onclick="$(this).parent().find(\'input\').attr(\'type\',\'file\');$(this).parent().find(\'img,a\').remove()">Delete</a>';
                                                            } elseif ($rdata['image3']) {
                                                                echo '<input name="image3" value="' . $rdata['image3'] . '" type="hidden" class="form-control edit_product_image3 product_image3  " > <a target="_BLANK" href="../files/' . $rdata['image3'] . '" style="width:200px;" >Download ' . $rdata['image3'] . '</a> <br/> <a onclick="$(this).parent().find(\'input\').attr(\'type\',\'file\');$(this).parent().find(\'img,a\').remove()">Delete</a>';
                                                            } else {
                                                            ?>
                                                ...
                                                <div class="form-group has-error" style="border:none;">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <?php
                                                            if (
                                                                substr($rdata['image4'], -3) == 'png' || substr($rdata['image4'], -3) == 'jpg' || substr($rdata['image4'], -4) == 'jpeg' || substr($rdata['image4'], -3) == 'gif' || substr($rdata['image4'], -3) == 'bmp'
                                                                ||
                                                                substr($rdata['image4'], -3) == 'PNG' || substr($rdata['image4'], -3) == 'JPG' || substr($rdata['image4'], -4) == 'JPEG' || substr($rdata['image4'], -3) == 'GIF' || substr($rdata['image4'], -3) == 'BMP'
                                                            ) {
                                                                echo '<input name="image4" value="' . $rdata['image4'] . '" type="hidden" class="form-control   edit_product_image4 product_image4  " > <img src="../files/' . $rdata['image4'] . '" style="width:200px;" /> <br/> <a onclick="$(this).parent().find(\'input\').attr(\'type\',\'file\');$(this).parent().find(\'img,a\').remove()">Delete</a>';
                                                            } elseif ($rdata['image4']) {
                                                                echo '<input name="image4" value="' . $rdata['image4'] . '" type="hidden" class="form-control edit_product_image4 product_image4  " > <a target="_BLANK" href="../files/' . $rdata['image4'] . '" style="width:200px;" >Download ' . $rdata['image4'] . '</a> <br/> <a onclick="$(this).parent().find(\'input\').attr(\'type\',\'file\');$(this).parent().find(\'img,a\').remove()">Delete</a>';
                                                            } else {
                                                            ?>
                                                ...
                                                <div class="form-group has-error" style="border:none;">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <?php
                                                            if (
                                                                substr($rdata['image5'], -3) == 'png' || substr($rdata['image5'], -3) == 'jpg' || substr($rdata['image5'], -4) == 'jpeg' || substr($rdata['image5'], -3) == 'gif' || substr($rdata['image5'], -3) == 'bmp'
                                                                ||
                                                                substr($rdata['image5'], -3) == 'PNG' || substr($rdata['image5'], -3) == 'JPG' || substr($rdata['image5'], -4) == 'JPEG' || substr($rdata['image5'], -3) == 'GIF' || substr($rdata['image5'], -3) == 'BMP'
                                                            ) {
                                                                echo '<input name="image5" value="' . $rdata['image5'] . '" type="hidden" class="form-control   edit_product_image5 product_image5  " > <img src="../files/' . $rdata['image5'] . '" style="width:200px;" /> <br/> <a onclick="$(this).parent().find(\'input\').attr(\'type\',\'file\');$(this).parent().find(\'img,a\').remove()">Delete</a>';
                                                            } elseif ($rdata['image5']) {
                                                                echo '<input name="image5" value="' . $rdata['image5'] . '" type="hidden" class="form-control edit_product_image5 product_image5  " > <a target="_BLANK" href="../files/' . $rdata['image5'] . '" style="width:200px;" >Download ' . $rdata['image5'] . '</a> <br/> <a onclick="$(this).parent().find(\'input\').attr(\'type\',\'file\');$(this).parent().find(\'img,a\').remove()">Delete</a>';
                                                            } else {
                                                            ?>
                                                ...
                                                <div class="form-group has-error" style="border:none;">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <?php
                                                            if (
                                                                substr($rdata['image6'], -3) == 'png' || substr($rdata['image6'], -3) == 'jpg' || substr($rdata['image6'], -4) == 'jpeg' || substr($rdata['image6'], -3) == 'gif' || substr($rdata['image6'], -3) == 'bmp'
                                                                ||
                                                                substr($rdata['image6'], -3) == 'PNG' || substr($rdata['image6'], -3) == 'JPG' || substr($rdata['image6'], -4) == 'JPEG' || substr($rdata['image6'], -3) == 'GIF' || substr($rdata['image6'], -3) == 'BMP'
                                                            ) {
                                                                echo '<input name="image6" value="' . $rdata['image6'] . '" type="hidden" class="form-control   edit_product_image6 product_image6  " > <img src="../files/' . $rdata['image6'] . '" style="width:200px;" /> <br/> <a onclick="$(this).parent().find(\'input\').attr(\'type\',\'file\');$(this).parent().find(\'img,a\').remove()">Delete</a>';
                                                            } elseif ($rdata['image6']) {
                                                                echo '<input name="image6" value="' . $rdata['image6'] . '" type="hidden" class="form-control edit_product_image6 product_image6  " > <a target="_BLANK" href="../files/' . $rdata['image6'] . '" style="width:200px;" >Download ' . $rdata['image6'] . '</a> <br/> <a onclick="$(this).parent().find(\'input\').attr(\'type\',\'file\');$(this).parent().find(\'img,a\').remove()">Delete</a>';
                                                            } else {
                                                            ?>
                                                ...
                                                <div class="form-group has-error" style="border:none;">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <?php
                                                            if (
                                                                substr($rdata['image7'], -3) == 'png' || substr($rdata['image7'], -3) == 'jpg' || substr($rdata['image7'], -4) == 'jpeg' || substr($rdata['image7'], -3) == 'gif' || substr($rdata['image7'], -3) == 'bmp'
                                                                ||
                                                                substr($rdata['image7'], -3) == 'PNG' || substr($rdata['image7'], -3) == 'JPG' || substr($rdata['image7'], -4) == 'JPEG' || substr($rdata['image7'], -3) == 'GIF' || substr($rdata['image7'], -3) == 'BMP'
                                                            ) {
                                                                echo '<input name="image7" value="' . $rdata['image7'] . '" type="hidden" class="form-control   edit_product_image7 product_image7  " > <img src="../files/' . $rdata['image7'] . '" style="width:200px;" /> <br/> <a onclick="$(this).parent().find(\'input\').attr(\'type\',\'file\');$(this).parent().find(\'img,a\').remove()">Delete</a>';
                                                            } elseif ($rdata['image7']) {
                                                                echo '<input name="image7" value="' . $rdata['image7'] . '" type="hidden" class="form-control edit_product_image7 product_image7  " > <a target="_BLANK" href="../files/' . $rdata['image7'] . '" style="width:200px;" >Download ' . $rdata['image7'] . '</a> <br/> <a onclick="$(this).parent().find(\'input\').attr(\'type\',\'file\');$(this).parent().find(\'img,a\').remove()">Delete</a>';
                                                            } else {
                                                            ?>
                                                ...
                                                <div class="form-group has-error" style="border:none;">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <?php
                                                            if (
                                                                substr($rdata['image8'], -3) == 'png' || substr($rdata['image8'], -3) == 'jpg' || substr($rdata['image8'], -4) == 'jpeg' || substr($rdata['image8'], -3) == 'gif' || substr($rdata['image8'], -3) == 'bmp'
                                                                ||
                                                                substr($rdata['image8'], -3) == 'PNG' || substr($rdata['image8'], -3) == 'JPG' || substr($rdata['image8'], -4) == 'JPEG' || substr($rdata['image8'], -3) == 'GIF' || substr($rdata['image8'], -3) == 'BMP'
                                                            ) {
                                                                echo '<input name="image8" value="' . $rdata['image8'] . '" type="hidden" class="form-control   edit_product_image8 product_image8  " > <img src="../files/' . $rdata['image8'] . '" style="width:200px;" /> <br/> <a onclick="$(this).parent().find(\'input\').attr(\'type\',\'file\');$(this).parent().find(\'img,a\').remove()">Delete</a>';
                                                            } elseif ($rdata['image8']) {
                                                                echo '<input name="image8" value="' . $rdata['image8'] . '" type="hidden" class="form-control edit_product_image8 product_image8  " > <a target="_BLANK" href="../files/' . $rdata['image8'] . '" style="width:200px;" >Download ' . $rdata['image8'] . '</a> <br/> <a onclick="$(this).parent().find(\'input\').attr(\'type\',\'file\');$(this).parent().find(\'img,a\').remove()">Delete</a>';
                                                            } else {
                                                            ?>
                                                ...
                                                <div class="form-group has-error" style="border:none;">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <?php
                                                            if (
                                                                substr($rdata['image9'], -3) == 'png' || substr($rdata['image9'], -3) == 'jpg' || substr($rdata['image9'], -4) == 'jpeg' || substr($rdata['image9'], -3) == 'gif' || substr($rdata['image9'], -3) == 'bmp' || substr($rdata['image9'], -3) == 'svg'
                                                                ||
                                                                substr($rdata['image9'], -3) == 'PNG' || substr($rdata['image9'], -3) == 'JPG' || substr($rdata['image9'], -4) == 'JPEG' || substr($rdata['image9'], -3) == 'GIF' || substr($rdata['image9'], -3) == 'BMP'
                                                            ) {
                                                                echo '<input name="image9" value="' . $rdata['image9'] . '" type="hidden" class="form-control   edit_product_image9 product_image9  " > <img src="../files/' . $rdata['image9'] . '" style="width:200px;" /> <br/> <a onclick="$(this).parent().find(\'input\').attr(\'type\',\'file\');$(this).parent().find(\'img,a\').remove()">Delete</a>';
                                                            } elseif ($rdata['image9']) {
                                                                echo '<input name="image9" value="' . $rdata['image9'] . '" type="hidden" class="form-control edit_product_image9 product_image9  " > <a target="_BLANK" href="../files/' . $rdata['image9'] . '" style="width:200px;" >Download ' . $rdata['image9'] . '</a> <br/> <a onclick="$(this).parent().find(\'input\').attr(\'type\',\'file\');$(this).parent().find(\'img,a\').remove()">Delete</a>';
                                                            } else {
                                                            ?>
                                                ...
                                                <!-- <div class="form-group has-error" style="border:none;">
                                                        <div class="control-group">
                                                            ...
                                                            <div class="col-md-9"> 
                                                                ...
                                                                if (substr($rdata['image10'], -3) == 'png' || substr($rdata['image10'], -3) == 'jpg' || substr($rdata['image10'], -4) == 'jpeg' || substr($rdata['image10'], -3) == 'gif' || substr($rdata['image10'], -3) == 'bmp') {
                                                                    echo '<input name="image10" value="' . $rdata['image10'] . '" type="hidden" class="form-control   edit_product_image10 product_image10  " > <img src="../files/' . $rdata['image10'] . '" style="width:200px;" /> <br/> <a onclick="$(this).parent().find(\'input\').attr(\'type\',\'file\');$(this).parent().find(\'img,a\').remove()">Delete</a>';
                                                                } elseif ($rdata['image10']) {
                                                                    echo '<input name="image10" value="' . $rdata['image10'] . '" type="hidden" class="form-control edit_product_image10 product_image10  " > <a target="_BLANK" href="../files/' . $rdata['image10'] . '" style="width:200px;" >Download ' . $rdata['image10'] . '</a> <br/> <a onclick="$(this).parent().find(\'input\').attr(\'type\',\'file\');$(this).parent().find(\'img,a\').remove()">Delete</a>';
                                                                } else {
                                                                    ?>
