...
if (isset($_POST['submit'])) {
    ...
    if ($q) {
        ...
        echo "<script>alert('New Payment added');window.location='index.php?p=payment';</script>";
    }
}
?>

<div class="page-header" > 
            <div class="page-title"> <h3>Payments</h3> </div> 
...
<div class="panel panel-default" style="vertical-align: top; ">
        <div class="panel-heading " style="vertical-align: top;">
            <h3 class="panel-title"> <a class="accordion-toggle" data-toggle="collapse" data-parent="" href="">Payment Detail</a> </h3>
        </div>
