var FormComponents = function() {
    ...
    var c = function() {
        if ($.fn.inputlimiter) {
            $.extend(true, $.fn.inputlimiter.defaults, {boxAttach: false, boxId: "limit-text", remText: "%n character%s remaining.", limitText: "Field limited to %n character%s.", zeroPlural: true});
    ...
    var d = function() {
        if ($.validator) {
            $.extend($.validator.defaults, {errorClass: "has-error", validClass: "has-success", highlight: function(o, m, n) {
                    if (o.type === "radio") {
                        this.findByName(o.name).addClass(m).removeClass(n)
                    } else {
                        $(o).addClass(m).removeClass(n)
                    }
                    $(o).closest(".form-group").addClass(m).removeClass(n)
                    ...
                    $(o).closest(".form-group").removeClass(m).addClass(n);
                    $(o).closest(".form-group").find('label[generated="true"]').html("")
                }});
            var l = $.validator.prototype.resetForm;
            $.extend($.validator.prototype, {resetForm: function() {
                    l.call(this);
                    ...
                    if (m.length) {
                        ...
                        m = $("<" + this.settings.errorElement + "/>").attr({"for": this.idOrName(n), generated: true}).addClass(this.settings.errorClass).addClass("help-block").html(o || "");
    ...
    var h = function() {
        if ($.fn.wysihtml5) {
            $.extend(true, $.fn.wysihtml5.defaultOptions, {stylesheets: ["./css/bootstrap-wysihtml5.css"]});
