...
if (isset($_POST['update'])) {
    ...
    if ($q) {
        echo "<script>alert('Size Updated');window.location='index.php?p=sizemaster'; </script>"; //
    }
}
$sql = "select * from sizemaster where id=" . $_GET['id'];
$q = mysql_query($sql);
...
if ($_GET['del']) {   // when click on delete link this will be called and delete image from database
    ...
    $sql = "update sizemaster set `" . $_GET['del'] . "`='" . implode(',', $datadel) . "' where id=" . $_GET['id'];
    $q = mysql_query($sql);
    echo "<script>alert('Size Updated'); window.location='index.php?p=editsize&id=" . $_GET['id'] . "';</script>";
}
?> 
                                    ...
                                    <div class="panel-body"> 
                                        <table id="table">
                                            <tbody>
                                                <tr>
                                                    <td> 
                                                        <label style="width:125px;"> Size:</label>   
