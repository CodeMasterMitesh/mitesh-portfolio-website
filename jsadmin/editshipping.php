...
if (isset($_POST['name'])) {
    ...
    if ($q) {
        ...
        $j=$i;
        echo "<script>alert('Shipping Updated'); </script>"; //window.location='index.php?p=searchproduct';
    }
}
...
if ($_GET['del']) {   // when click on delete link this will be called and delete image from database
    ...
    $q = mysql_query($sql);
    echo "<script>alert('Shipping Updated'); window.location='index.php?p=editshipping&id=" . $_GET['id'] . "';</script>";
}
?> 

<div class="page-header" > 
            <div class="page-title"> <h3>Edit Shipping</h3> </div> 
            <a href="index.php?p=editshipping">
        ...
        <div class="panel-body" style="vertical-align: top;"> 
            ...
            <div class="form-group" >
                                            <table style="width:100%" id="imgtable">
                                                ...
                                                <tbody>
<?php 
$sql1="select * from shipping_details where pid=".$_GET['id'];
$q1=mysql_query($sql1) or die(mysql_error().$sql1);
