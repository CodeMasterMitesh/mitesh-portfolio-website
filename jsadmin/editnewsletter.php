...
if (isset($_POST['update'])) {
    ...
    if ($q) {
        echo "<script>alert('Newsletter Updated');window.location='index.php?p=newsletter'; </script>"; //
    }
}
...
if ($_GET['del']) {   // when click on delete link this will be called and delete image from database
    ...
    $sql = "update newsletter set `" . $_GET['del'] . "`='" . implode(',', $datadel) . "' where id=" . $_GET['id'];
    $q = mysql_query($sql);
    echo "<script>alert('Newsletter Updated'); window.location='index.php?p=newsletter&id=" . $_GET['id'] . "';</script>";
}
?> 
                                        ...
                                        <div class="widget box" style="border:none;">
                                            <div class="widget-content">
                                                ...
                                                <div class="form-group has-error" >
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" name="email" class="form-control required has-error" style="border-radius: 6px;">
