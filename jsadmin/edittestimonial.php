...
if (isset($_POST['name'])) {
    ...
    if ($q) {
        ...
        echo "<script>alert('Testimonial Updated');window.location='index.php?p=testimonial';</script>"; //window.location='index.php?p=searchproduct';
    }
}
...
if ($_GET['del']) {   // when click on delete link this will be called and delete image from database
    ...
    $sql = "update testimonial set `" . $_GET['del'] . "`='" . implode(',', $datadel) . "' where id=" . $_GET['id'];
    $q = mysql_query($sql);
    echo "<script>alert('Testimonial Updated'); window.location='index.php?p=testimonial';</script>";
}
?> 
<div class="page-header" style="margin: 20px;">
    <div class="page-title">
        <h3>Edit Testimonial <a href="html.php?id=<?php echo $rdata['id'] ?>"  class="btn btn-primary btn-primary " target="_BLANK" >Html Page</a></h3>
    </div>
</div>
                                    ...
                                    <div class="panel-body">
                                        <div class="widget box" style="border:none;">
                                            ...
                                            if (substr($rdata['image'], -3) == 'png' || substr($rdata['image'], -3) == 'jpg' || substr($rdata['image'], -4) == 'jpeg' || substr($rdata['image'], -3) == 'gif' || substr($rdata['image'], -3) == 'bmp') {
                                                echo '<input name="image" value="' . $rdata['image'] . '" type="hidden" class="form-control   edit_product_image product_image  " > <img src="../productimages/' . $rdata['image'] . '" style="width:200px;" /> <br/> <a onclick="$(this).parent().find(\'input\').attr(\'type\',\'file\');$(this).parent().find(\'img,a\').remove()">Delete</a>';
                                            } elseif ($rdata['image']) {
                                                echo '<input name="image" value="' . $rdata['image'] . '" type="hidden" class="form-control edit_product_image product_image  " > <a target="_BLANK" href="../productimages/' . $rdata['image'] . '" style="width:200px;" >Download ' . $rdata['image'] . '</a> <br/> <a onclick="$(this).parent().find(\'input\').attr(\'type\',\'file\');$(this).parent().find(\'img,a\').remove()">Delete</a>';
                                            } else {
                                                ?>
                                    ...
                                    <div class="widget-content">
                                        <div class="form-group" >
                                            <table style="width:100%" id="imgtable">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $sql1 = "select * from productimages where pid=" . $_GET['id'];
                                                    $q1 = mysql_query($sql1) or die(mysql_error() . $sql1);
                                                    while ($r1 = mysql_fetch_assoc($q1)) {
                                                        ?>
                                                        <tr>
                                                            <td>
                                                                <img src="../catalog/<?php echo $r1['name']; ?>" style="width:100px;" />
                                                                <input type="hidden" name="prodimg_name[]" value="<?php echo $r1['name'] ?>"   /></td>
                                                            <td><input type="text" name="prodimg_alttext[]" value="<?php echo $r1['alttext'] ?>" class="form-control"  /></td>
                                                            <td>
                                                                <select class="select1" name="prodimg_position[]">
                                                                    <option <?php if ($r1['position'] == 'Banner(565px X 240px)') echo 'selected="selected"'; ?>>Banner(565px X 240px)</option>
                                                                    <option <?php if ($r1['position'] == 'Home Page Center Section(450px X 300px)') echo 'selected="selected"'; ?>>Home Page Center Section(450px X 300px)</option>
                                                                    <option <?php if ($r1['position'] == 'Home Page Footer Banner(300px X 250px)') echo 'selected="selected"'; ?>>Home Page Footer Banner(300px X 250px)</option>
                                                                    <option <?php if ($r1['position'] == 'Testimonial Page Image(800px X 500px)') echo 'selected="selected"'; ?>>Product Page Image(800px X 500px)</option>
                                                                </select>
                                                            </td>
                                ...
                                <div class="widget box" style="border:none;">
                                    <div class="widget-content">
                                        ...
                                        <div class="form-group has-error" >
                                            ...
                                            <div class="col-md-9"> 
                                                <input type="text"  id="price" name="price" class="form-control required has-error" style="width: 150px;border-radius: 6px;" ><label for="req1" generated="true" class="has-error help-block" style="color:#fff;">.</label>  
                                            </div>
                                    ...
                                    <div class="widget-content">
                                        <div class="form-group" >
                                            <table style="width:100%" class="imgtable">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><?php echo getoptn('option_oid', 'name', 'id', 'options', 'select1', "", "", "None") ?></td>
