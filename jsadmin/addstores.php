...
<form class="form-horizontal row-border" id="validate-1" method="post"  action="" novalidate="novalidate">
    ...
    <table style="width: 50%;vertical-align: top;">
        <tr>
            <td>
                Copy existing store configuration
            </td>
            <td>
            ...
            <div class="widget">
                <div class="widget-content">
                    <div class="panel-group" id="accordion">
                        <div class="panel panel-default" style="margin-left: -5px;">
                            <div class="panel-heading">
                                <h3 class="panel-title"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseOne"> Settings: Company</a> </h3>
                            </div>
                            <div id="collapseOne" class="panel-collapse in" style="height: auto;">
                                <div class="panel-body"> 
                    ...
                    <option value="">- Select country -</option>
                                            ...
                                            <option value="ZW">Zimbabwe</option>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                Support department e-mail address
            ...
            <div class="widget">
                <div class="widget-content">
                    <div class="panel-group" id="accordion">
                        <div class="panel panel-default" style="margin-left: -5px;">
                            <div class="panel-heading">
                                <h3 class="panel-title"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseOne"> Regions</a> </h3>
                            </div>
                            <div id="collapseOne" class="panel-collapse in" style="height: auto;">
                                <div class="panel-body"> 
                                    ...
                                    <div class="widget box" style="border:none;">
                                        <div class="widget-content">
                                            ...
                                            <table style="width: 100%;vertical-align: top;line-height: 45px;" class="tables">
                                                <tr>
                                                    <td colspan="4">
                                                        Redirect visitors of this storefront to the one that has countries to which the visitors' IP addresses belong defined
                                                    </td>
                                                    <td>
                                                        <input type="radio"  name="redirect" style="padding-left: 10px;" > Yes  <input type="radio"  name="redirect"  > No
