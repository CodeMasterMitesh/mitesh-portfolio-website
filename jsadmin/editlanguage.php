                                    ...
                                    <div class="widget-content">
                                        ...
                                        <table style="width: 100%;vertical-align: top;line-height: 45px;" class="tables">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                  <input type="radio"  name="status" > Active  <input type="radio"  name="status" style="margin-left:10px;" > Hidden
                                                    <input type="radio"  name="status" style="margin-left:10px;" > Disabled
